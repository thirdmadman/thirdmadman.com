...
export const PROJECTS = [
  ...
  {
    name: 'ArrowFlicks',
    description: 'A movie search and discovery app that allows users to browse, rate movies.',
    sourceCodeLink: 'https://github.com/thirdmadman/pss2k24-arrowflicks',
    link: 'https://pss2k24-arrowflicks.thirdmadman.com/',
  },
  {
  ...
  {
    name: 'ArtQuiz',
    description: 'ArtQuiz is a quiz application for knowledge of masterpieces of painting and their authors.',
    sourceCodeLink: 'https://github.com/thirdmadman/fe-training-JSFE2021Q3-art-quiz',
    link: 'https://thirdmadman.github.io/fe-training-JSFE2021Q3-art-quiz/',
  },
];
